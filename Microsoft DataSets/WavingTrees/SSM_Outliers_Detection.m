function [outliers] = SSM_Outliers_Detection(datapath,ending,NOutliers,boolTreshold)
% datapath_format = "C:\......\*.bmp ro *.jpg and so on
full_path = [datapath ending];
imagefiles = dir(full_path);      
%nfiles = frames;
numOfframes = length(imagefiles);%100
